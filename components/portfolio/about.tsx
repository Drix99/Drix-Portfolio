      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-background/40 to-background/20 border border-foreground/10 rounded-2xl p-8 md:p-12 mb-20 hover:border-primary/20 transition-all duration-300">
          ...
          <div className="space-y-4 text-foreground/70 leading-relaxed">
            <p>
              I started my coding journey with curiosity and a determination to build things that matter. Over the past 2+ years, 
              I've evolved from learning basic web development to creating full-scale applications that solve real-world problems.
            </p>
            <p>
              My expertise spans modern frontend frameworks like React and Vue.js, backend development with Node.js and PHP, 
              and mobile development using Flutter. I'm passionate about writing clean, maintainable code and following best practices.
            </p>
            <p>
